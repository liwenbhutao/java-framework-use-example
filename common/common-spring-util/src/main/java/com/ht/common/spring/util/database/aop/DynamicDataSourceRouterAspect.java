...
public class DynamicDataSourceRouterAspect {
    /**
     */
    @Pointcut("@within(com.ht.common.spring.util.database.aop.DynamicDataSourceAnnotation)")
    public void classAnnotationPointcut() {
    }

    /**
     */
    @Pointcut("@annotation(com.ht.common.spring.util.database.aop.DynamicDataSourceAnnotation)")
